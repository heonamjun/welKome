...
import com.welkome.sktrip.Retrofit.checkData;
...
public class firstpageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * 생성자
     */
    public firstpageAdapter(ArrayList<com.welkome.sktrip.Data.GradeTourData> GradeTourData, Context context, int layoutId, OnItemClick mCallback) {
