...
import com.welkomelite.sktrip.Retrofit.checkData;
...
public class firstpageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<com.welkomelite.sktrip.Data.GradeTourData> GradeTourData;
     ...
     * 생성자
     */
    public firstpageAdapter(ArrayList<com.welkomelite.sktrip.Data.GradeTourData> GradeTourData, Context context, int layoutId, OnItemClick mCallback) {
