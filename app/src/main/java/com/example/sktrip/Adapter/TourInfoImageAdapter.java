...
public class TourInfoImageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<com.example.sktrip.Data.TourInfoImageData> TourInfoImageData;
     ...
     * 생성자
     */
    public TourInfoImageAdapter(ArrayList<com.example.sktrip.Data.TourInfoImageData> TourInfoImageData, Context context, int layoutId ) {
